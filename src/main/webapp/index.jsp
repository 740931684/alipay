...
<div style="width: 100%;height: auto">
    ...
    <form action="/refundApply" method="get" target="_blank">
...
<div id="main">
    ...
    <form name=alipayment action=trade_pay method=post
          target="_blank">
    ...
    <form name=tradequery action=trade_query method=post
          target="_blank">
    ...
    <form name=traderefund action=trade_refund method=post
          target="_blank">
